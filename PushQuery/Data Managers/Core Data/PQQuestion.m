...
- (void)setSurvey:(PQSurvey *)survey {
    ...
    [NSNotificationCenter postNotificationToMainThread:PQQuestionSurveyDidChangeNotification object:self userInfo:userInfo];
}
...
- (void)willSave {
    ...
    [NSNotificationCenter postNotificationToMainThread:PQQuestionWillBeSavedNotification object:self userInfo:@{NOTIFICATION_OBJECT_KEY : self.changedKeys}];
}
...
- (void)didSave {
    ...
    [NSNotificationCenter postNotificationToMainThread:PQQuestionWasSavedNotification object:self userInfo:[NSDictionary dictionaryWithNullableObject:self.changedKeys forKey:NOTIFICATION_OBJECT_KEY]];
...
- (void)addChoice:(PQChoice *)choice {
    ...
    [NSNotificationCenter postNotificationToMainThread:PQQuestionChoiceWasAddedNotification object:self userInfo:userInfo];
}
...
=======
    ...
    [NSNotificationCenter postNotificationToMainThread:PQQuestionChoiceWasReorderedNotification object:self userInfo:userInfo];
>>>>>>> ef63e612b5df8adbd9629af7cf8060a22047dbb4
}
...
- (void)replaceChoiceAtIndex:(NSUInteger)index withChoice:(PQChoice *)choice {
    ...
    [NSNotificationCenter postNotificationToMainThread:PQQuestionChoiceAtIndexWasReplaced object:self userInfo:userInfo];
}
...
//    [NSNotificationCenter postNotificationToMainThread:PQQuestionChoiceWillBeRemoved object:self userInfo:userInfo];
    ...
    [NSNotificationCenter postNotificationToMainThread:PQQuestionChoiceAtIndexWasRemovedNotification object:self userInfo:userInfo];
}
...
- (void)addResponse:(PQResponse *)response {
    ...
    [NSNotificationCenter postNotificationToMainThread:PQQuestionResponseWasAddedNotification object:self userInfo:userInfo];
...
//    [NSNotificationCenter postNotificationToMainThread:PQQuestionResponseWillBeRemovedNotification object:self userInfo:userInfo];
    ...
    [NSNotificationCenter postNotificationToMainThread:PQQuestionResponseWasRemovedNotification object:self userInfo:userInfo];
