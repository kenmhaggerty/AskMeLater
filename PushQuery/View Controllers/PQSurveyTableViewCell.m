...
NSTimeInterval const PQSurveyTableViewCellAnimationDuration = 0.15f;

@interface PQSurveyTableViewCell () <UITextViewDelegate>
...
@implementation PQSurveyTableViewCell
...
+ (NSString *)reuseIdentifier {
    ...
    return NSStringFromClass([PQSurveyTableViewCell class]);
}
...
- (void)textViewDidBeginEditing:(UITextView *)textView {
    ...
    [UIView animateWithDuration:PQSurveyTableViewCellAnimationDuration animations:^{
